...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {JUMP}]					
...
#set_property PACKAGE_PIN R2 [get_ports {sw[15]}]					
 ...
 #LEDs
#set_property PACKAGE_PIN U16 [get_ports {DONE1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {DONE1}]
#set_property PACKAGE_PIN E19 [get_ports {DONE2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {DONE2}]
set_property PACKAGE_PIN U19 [get_ports {DONE3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DONE3}]
#set_property PACKAGE_PIN V19 [get_ports {NUM}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {NUM}]
#set_property PACKAGE_PIN W18 [get_ports {led_out[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_out[4]}]
set_property PACKAGE_PIN U15 [get_ports {DONE4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DONE4}]
#set_property PACKAGE_PIN U14 [get_ports {NUM}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {NUM}]
...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {co[6]}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {co[6]}]
set_property PACKAGE_PIN W6 [get_ports {co[5]}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {co[5]}]
set_property PACKAGE_PIN U8 [get_ports {co[4]}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {co[4]}]
set_property PACKAGE_PIN V8 [get_ports {co[3]}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {co[3]}]
set_property PACKAGE_PIN U5 [get_ports {co[2]}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {co[2]}]
set_property PACKAGE_PIN V5 [get_ports {co[1]}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {co[1]}]
set_property PACKAGE_PIN U7 [get_ports {co[0]}]                    
    set_property IOSTANDARD LVCMOS33 [get_ports {co[0]}]

#set_property PACKAGE_PIN V7 [get_ports dp]							
	#set_property IOSTANDARD LVCMOS33 [get_ports dp]

set_property PACKAGE_PIN U2 [get_ports {ao[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ao[3]}]
set_property PACKAGE_PIN U4 [get_ports {ao[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ao[2]}]
set_property PACKAGE_PIN V4 [get_ports {ao[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ao[1]}]
set_property PACKAGE_PIN W4 [get_ports {ao[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ao[0]}]


#Buttons
set_property PACKAGE_PIN U18 [get_ports JUMP]						
	set_property IOSTANDARD LVCMOS33 [get_ports JUMP]
...
#	set_property IOSTANDARD LVCMOS33 [get_ports {SDIN}]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {pmod_input}]					
